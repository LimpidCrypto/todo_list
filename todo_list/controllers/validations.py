...
def validate_list_existence(list_id: UUID) -> Optional[Tuple[str, int]]:
    ...
    Returns:
        Optional[Tuple[str, int]]: A tuple containing an error message and status code if the todo list does not exist, otherwise None.
    """
    try:
...
def validate_todo_existence(todo_id: UUID) -> Optional[Tuple[str, int]]:
    ...
    Returns:
        Optional[Tuple[str, int]]: A tuple containing an error message and status code if the todo item does not exist, otherwise None.
    """
    try:
